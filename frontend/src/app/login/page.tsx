    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-warm-50">
      ...
      >
        <div className="text-center mb-8">
          <h1 className="text-2xl font-semibold text-charcoal tracking-tight">JiraBrief AI</h1>
          <p className="text-warm-500 mt-1 text-sm">Sign in to your account</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-warm-200 p-6">
          <button
            ...
            type="button"
            className="w-full flex items-center justify-center gap-2 py-2.5 border border-warm-200 rounded-xl text-sm font-medium text-charcoal hover:bg-warm-50 transition-colors cursor-pointer"
          >
          ...
          <div className="flex items-center my-5">
            ...
            <span className="px-3 text-xs text-warm-400">or</span>
            <div className="flex-1 h-px bg-warm-200" />
          </div>
          ...
          <div className="mt-4 flex items-center justify-between text-xs">
            <Link href="/forgot-password" className="text-warm-500 hover:text-charcoal transition-colors">
              Forgot password?
            </Link>
